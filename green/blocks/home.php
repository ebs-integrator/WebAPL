...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        ...
        <header>
            <img src="img/backgr1.png" class="background">
            <div class="row1">
                <div class="left">
                ...
                <div class="contact right"><p class="tel">(022) 22-32-53</p>
                    <div class="cont">
                        ...
                        <div class="cont_form hidden">
                            ...
                            <form id="contact_top_form" action="" method="post">
                                <div class="form_error"></div>
                                <input type="text" name="name" placeholder="Nume, Prenume">
                                <input type="text" name="email" placeholder="Email">
                                <textarea name="message" placeholder="Mesaj"></textarea>
                                <input name="capcha" class="code" type="text">
                                <img src="data:image/png;base64," height="37">
