    ...
    <div class="wrap com">
        ...
        <div class='left'>                
            <div class="com_box">
                ...
                <p class="subtitle">Comisia pentru prognoză şi programe de dezvoltare economică, buget, finanţe, agricultură, administrarea domeniului public şi privat al municipiului:</p>
            ...
            <div class="com_box">
                <p class="title">Comisia de Urbanism</p>
                <p class="subtitle">Comisia pentru amenajarea teritoriului, urbanism, protecţia mediului şi turism</p>
            ...
            <div class="com_box">
                <p class="title">Comisia Învăţământ</p>
                <p class="subtitle">Comisia pentru activităţi social-culturale, culte, învăţământ, tineret, activităţi sportive şi de agrement </p>
        ...
        <div class='right'>
            <ul class="right_menu">
                ...
                <li class="active" ><a href="javascript:;">Comisiile primăriei</a></li>
