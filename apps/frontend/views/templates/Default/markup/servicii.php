<section>
    ...
    <div class="menu">
        ...
        <div class="wrap">
            <div class="box">
                <a href="javascript:;">
                    <span class="menu_img" class="active"> <img src="<?= res('assets/img/menu1.png'); ?>"></span>
            ...
            <div class="box">
                <a href="javascript:;">
                    <span class="menu_img"><img src="<?= res('assets/img/menu2.png'); ?>"></span>
            ...
            <div class="box">
                <a href="javascript:;">
                    <span class="menu_img"><img src="<?= res('assets/img/menu3.png'); ?>"></span>
