...
class ExcelFile {
    ...
    /**
     * Builds a new ExcelFile Spreadsheet object
     * @return ExcelFile The Spreadsheet
     */
    ...
    function headers() {
        ...
        header("Content-Disposition: attachment;filename=" . ExcelFile::filename($this->title) . ".xls ");
    ...
    /**
     * Writes the ExcelFile Beginning of File marker
     * @see pack()
     * @return nothing
     */
    ...
    /**
     * Writes the ExcelFile End of File marker
     * @see pack()
     * @return nothing
     */
    ...
    /**
     * Writes a number to the ExcelFile Spreadsheet
     * @see pack()
    ...
    /**
     * Writes a string (or label) to the ExcelFile Spreadsheet
     * @see pack()
